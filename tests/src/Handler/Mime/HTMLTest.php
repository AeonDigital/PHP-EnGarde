...
use AeonDigital\EnGarde\Handler\Mime\HTML as HTML;
...
class HTMLTest extends TestCase
{
    ...
    public function test_constructor_ok()
    {
        ...
        $this->assertTrue(is_a($obj, HTML::class));
    }
    ...
    public function test_createResponseBody()
    {
        ...
        $expectedPath   = to_system_path($dirResources . "/responses/responseGET.html");
