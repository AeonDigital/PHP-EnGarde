...
use AeonDigital\EnGarde\Handler\Mime\JSON as JSON;
...
class JSONTest extends TestCase
{
    ...
    public function test_constructor_ok()
    {
        ...
        $this->assertTrue(is_a($obj, JSON::class));
    }
    ...
    public function test_createResponseBody()
    {
        ...
        $expectedPath   = to_system_path($dirResources . "/responses/responseGET.json");
