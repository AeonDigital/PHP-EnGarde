...
use AeonDigital\EnGarde\Handler\Mime\XHTML as XHTML;
...
class XHTMLTest extends TestCase
{
    ...
    public function test_constructor_ok()
    {
        ...
        $this->assertTrue(is_a($obj, XHTML::class));
    }
    ...
    public function test_createResponseBody()
    {
        ...
        $expectedPath   = to_system_path($dirResources . "/responses/responseGET.xhtml");
