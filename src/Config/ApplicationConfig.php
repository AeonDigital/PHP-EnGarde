...
final class ApplicationConfig implements iApplicationConfig
{
     ...
     * 
     * Todas as demais configurações que indicam diretórios ou arquivos
     * usando caminhos relativos iniciam a partir deste diretório.
     *
     * @return      string
     */
    ...
    /**
     * Define o caminho relativo (a partir de "appRootPath") até o arquivo 
     ...
     * que estarão armazenados os recursos para as views (imagens, JS, CSS ...).
     *
     * @var         string
     */
    private $pathToViewsResources = null;
    /**
     * Retorna o caminho relativo (a partir de "appRootPath") até o diretório 
     * que estarão armazenados os recursos para as views (imagens, JS, CSS ...).
     *
     * @return      string
     */
    ...
    /**
     * Define o caminho relativo (a partir de "appRootPath") até o diretório 
     * que estarão armazenados os recursos para as views (imagens, JS, CSS ...).
     *
    ...
    /**
     * Retorna a Namespace comum à todos os controllers da 
     * aplicação corrente. 
     *
     * @return      string
     */
    ...
    /**
     * Define a Namespace comum à todos os controllers da 
     * aplicação corrente. 
     * 
    ...
    public function setDefaultLocale(string $locale) : void
    {
        if ($this->defaultLocale === null) {
            ...
            if (in_array_ci($locale, $this->locales) === false) {
    ...
    /**
     * Retorna um array associativo contendo os valores padrões para
     * as rotas de toda a aplicação. Estes valores podem ser sobrescritos
     * pelas definições padrões dos controllers e das próprias rotas. 
     *
     * @return      array
     */
    ...
    /**
     * Define um array associativo contendo os valores padrões para
     * as rotas de toda a aplicação. Estes valores podem ser sobrescritos
     * pelas definições padrões dos controllers e das próprias rotas. 
     * 
     * Neste momento da configuração apenas as seguintes propriedades podem
     * ser definidas:
     * 
     * - setAcceptMimes     | - setIsUseXHTML
     * - setMiddlewares     | - setDescription
     * - setIsSecure        | - setIsUseCache
     * - setCacheTimeout    | - setMasterPage
     * - setStyleSheets     | - setJavaScripts
     * - setMetaData        | - setResponseHeaders
     *
    ...
    public function setDefaultRouteConfig(array $defaultRouteConfig) : void
    {
        if (count($this->defaultRouteConfig) === 0) {
            ...
            foreach ($defaultRouteConfig as $key => $value) {
                if (in_array_ci($key, $allowedProperties) === true && $value !== null) {
     ...
     * para a aplicação.
     * 
     * Se ambos os parametros forem definidos o método "autoSetProperties"
     * será executado.
     * 
     ...
     *              Caso seja definido um valor inválido.
     */
    function __construct(string $appName = "", string $rootPath = "")
    {
        if ($appName !== "" && $rootPath !== "") {
    ...
    /**
     * Define as propriedades da aplicação que podem ser inferidas a partir
     * do seu nome e caminho até a raiz do domínio.
     * 
     * @param       string $appName
     *              Nome da aplicação.
     * 
