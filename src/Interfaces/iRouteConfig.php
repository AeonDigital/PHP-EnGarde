...
/**
 * Interface usada para representar a configuração de uma determinada
 * rota em execução de uma aplicação.
 * 
...
interface iRouteConfig
{
     ...
     *              Use "true" para definir que 
     *              a rota deve ser cacheada.
     * 
     * @return      void
     */
     ...
     * @return      void
     */
    function setCacheFilename(? string $cacheFileName) : void;
     ...
     * @return      void
     */
    function setIsDownload(bool $isDownload) : void;
     ...
     * @return      void
     */
    function setDownloadFileName(? string $downloadFileName) : void;
