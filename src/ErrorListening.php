...
final class ErrorListening
{
    ...
    /**
     * Define o contexto do ambiente carregando as propriedades 
     * básicas da instância.
     * 
    ...
    /**
     * Retorna um array associativo contendo o valor das variáveis
     * do contexto atual.
     *
     * @return      array
     */
    ...
    /**
     * Elimina totalmente todos os valores das propriedades
     * de contexto.
     * 
     * Este método apenas surte efeito se o ambiente onde está 
     * rodando estiver definido como "test".
     *
     * @return void
     */
    ...
    /**
     * Monta um HTML básico para retornar ao usuário uma página não estilizada
     * de um erro disparado.
     *
     * @param       array $viewData
     *              Objeto de dados do processamento no momento atual.
     *
     ...
     * Este tipo de erro não apresenta informações além do 
     * código HTTP e da "reason phrase" definidos e não tem como função
     * ajudar a debugar a aplicação. 
     * 
     * Deve ser usado quando o desenvolvedor deseja lançar uma falha
     * explicita para o UA.
     *
     * @param       int $code
     *              Código HTTP.
     ...
     * 
     * Em um ambiente de testes retornará um array associativo
     * contendo os dados que seriam enviados ao UA.
     *
     * @param       array $viewData
     *              Objeto de dados do processamento no momento atual.
     *
